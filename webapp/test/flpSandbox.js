		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP_BTP_demo",
									"targetURL": "#harshadaproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"harshadaproject1-display": {
								"semanticObject": "harshadaproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=harshadaproject1",
									"url": sap.ui.require.toUrl("harshadaproject1")
								}
							}
						}
					}
